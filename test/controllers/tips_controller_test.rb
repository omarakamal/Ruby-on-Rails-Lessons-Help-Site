...
class TipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tip" do
    assert_difference("Tip.count") do
      post tips_url, params: { tip: { creator: @tip.creator, description: @tip.description, helpful_links: @tip.helpful_links, lesson_name: @tip.lesson_name } }
    end
  ...
  test "should update tip" do
    patch tip_url(@tip), params: { tip: { creator: @tip.creator, description: @tip.description, helpful_links: @tip.helpful_links, lesson_name: @tip.lesson_name } }
